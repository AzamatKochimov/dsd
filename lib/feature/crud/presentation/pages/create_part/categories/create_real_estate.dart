...
class CreateRealEstate extends ConsumerStatefulWidget {
  const CreateRealEstate({super.key});

  @override
  ConsumerState<CreateRealEstate> createState() => _CreateRealEstateState();
}

class _CreateRealEstateState extends ConsumerState<CreateRealEstate> {
  @override
                          ...
                          child: Container(
                            child: Column(
                              children: [
                                ...
                                CustomButton(
                                    height: 30, isActive: false, text: "Brick"),
                                CustomButton(
                                    height: 30, isActive: false, text: "Panel"),
                                CustomButton(
                                    height: 30,
                                    isActive: true,
                                    text: "Monolithic"),
                                CustomButton(
                                    height: 30, isActive: false, text: "Block"),
                                CustomButton(
                                    height: 30, isActive: false, text: "Wood"),
                              ],
                            ),
                          ),
                        ),
                          ...
                          child: Container(
                            child: Column(
                              children: [
                                ...
                                CustomButton(
                                    height: 30, isActive: false, text: "Yes"),
                                CustomButton(
                                    height: 30, isActive: false, text: "No"),
                              ],
                            ),
                          ),
                        ),
